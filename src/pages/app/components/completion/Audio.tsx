...
export const Audio = ({
  ...
  const { selectedSttProvider, jamunaiApiEnabled, selectedAudioDevices } =
    useApp();
  ...
  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {(jamunaiApiEnabled || speechProviderStatus) && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        ...
        side="bottom"
        className={`w-80 p-3 ${
          jamunaiApiEnabled || speechProviderStatus ? "hidden" : ""
        }`}
        sideOffset={8}
      >
